...
\begin{defn}
Let $ R $ be a ring with identity. An element $ a\in R $ is called a \defnem{unit} if there exists some $ b\in R $ such that $ ab=ba=1 $. The set of units of $ R $ is denoted $ R^* $.
\end{defn}
