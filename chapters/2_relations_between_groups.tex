...
\begin{thm}
Let $ G $ be a group and $ H $ be a subgroup of $ G $. Then, $ H $ is a normal subgroup of $ G $ if and only if there exists an epimorphism $ \phi:G\to G' $ for some group $ G' $ such that $ H=\ker(\phi) $.
\end{thm}
\begin{proof}
\todo{Do this proof!}
\end{proof}
