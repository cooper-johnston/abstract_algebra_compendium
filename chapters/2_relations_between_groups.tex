...
\begin{equation*}
    \mathcal{G}=\{(g_i)_{i\in I}\mid g_i\in G_i\text{ for all }i\in I\},
\end{equation*}
where $ (g_i)_{i\in I} $ denotes the sequence of $ g_i $s as a touple, together with the law of composition
\begin{equation*}
    \begin{array}{rccc}
        \odot: & \mathcal{G}\times\mathcal{G} & \to & \mathcal{G} \\
        & ((g_i)_{i\in I},(h_i)_{i\in I}) & \mapsto & (g_ih_i)_{i\in I}
    \end{array}
\end{equation*}
is a group.
\end{cor}
...
\begin{equation*}
    \mathcal{H}=\{(g_i)_{i\in I}\mid g_i\in G_i\text{ for all }i\in I, g_i\neq e_i\text{ for only finitely many }i\in I\},
\end{equation*}
where $ e_i $ denotes the neutral element of group $ G_i $, together with the law of composition $ \odot $ given in Corollary \ref{cor:direct_product}, is a group. Furthermore, $ \mathcal{H}=\mathcal{G} $ when $ I $ is finite; otherwise, $ \mathcal{H} $ is a proper subgroup of $ \mathcal{G} $.
\end{cor}

\begin{defn}
The group $ \mathcal{G} $ from Corollary \ref{cor:direct_product} is called the \defnem{direct product} of the $ g_i $s, denoted
\begin{equation*}
    \prod_{i\in I}G_i \quad\text{or}\quad G_1\times G_2\times\cdots\times G_n\text{ for finite }I.
\end{equation*}
The group $ \mathcal{H} $ from Corollary \ref{cor:direct_sum} is called the \defnem{direct sum} of the $ g_i $s, denoted
\begin{equation*}
    \bigoplus_{i\in I}G_i \quad\text{or}\quad G_1\oplus G_2\oplus\cdots\oplus G_n\text{ for finite }I.
\end{equation*}
\end{defn}
